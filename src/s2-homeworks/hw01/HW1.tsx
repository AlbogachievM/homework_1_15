...
/*
* 1 X - описать тип MessageType
* 2 X - описать тип MessagePropsType в файле Message.tsx
* 3 X - в файле Message.tsx отобразить приходящие данные
* 4 X - выполнить пункты 2, 3 в файле FriendMessage.tsx
